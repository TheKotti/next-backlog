...
export const gameTableColumns: Column<Partial<Game>>[] = [
    ...
    },
    {
        Header: 'Game',
        accessor: 'title',
        Cell: ({ value, row, showCovers }) =>
            TitleCell({ value, row, showCovers }),
        sortType: titleSort,
        sortDescFirst: true,
    },
    {
    ...
    },
    {
        ...
        Cell: ({ value, row, handleTagFilterChange }) =>
            CommentCell({ value, row, handleTagFilterChange }),
        disableSortBy: true,
    },
    {
        Header: 'Finished',
    ...
    },
    {
        ...
        disableSortBy: true,
        Cell: ({ value, row }) =>
            AdminCell({ value, row, showVodButton: true }),
    },
]

export const backlogTableColumns: Column<
    Partial<Game & { hltbString: string }>
>[] = [
    {
        Header: 'Game',
        accessor: 'title',
