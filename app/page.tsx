...
async function getGames(): Promise<Game[]> {
    ...
    const res: Game[] = await db.collection('games').find().toArray()
            ...
            <div className="d-flex justify-content-between">
                ...
                <div className="row gx-3">
                    {process.env.ADMIN_USER_NAME == 'TheKotti' && (
                        <>
                            <a
                                href="https://www.youtube.com/thekotti"
                                target="_blank"
                                rel="noreferrer"
                                className="col"
                            >
                            ...
                            <a
                                href="https://www.twitch.tv/thekotti"
                                target="_blank"
                                rel="noreferrer"
                                className="col"
                            >
                            ...
                            <a
                                href="https://bsky.app/profile/thekotti.bsky.social"
                                target="_blank"
                                rel="noreferrer"
                                className="col"
                            >
                            ...
                            <a
                                href="https://discord.gg/thekotti"
                                target="_blank"
                                rel="noreferrer"
                                className="col"
                            >
